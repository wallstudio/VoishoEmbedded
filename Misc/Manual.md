...
けだまっちそのものの**アフターサポートは基本的に行いません**．一応，ご連絡いただければお答えするかもしれませんが，これは必ずされるものではありません．

けだまっちが故障した場合の修理は**無償・有償含め行いません**．設計書は公開（[https://github.com/wallstudio/VoishoEmbedded (Github)](https://github.com/wallstudio/VoishoEmbedded)）されているので，ご自身で修理する助けになるかもしれません．